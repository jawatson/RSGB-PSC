...
has been modified to modified to accept command line arguments.
...
print("Predicted Values: {:s}".format(fname1))
print("Measured Values: {:s}".format(fname2))
...
print("Written difference to {:s}".format(f3.name))
